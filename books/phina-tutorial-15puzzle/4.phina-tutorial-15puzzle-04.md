...
[（その３）【ピースのタッチ】](https://qiita.com/alkn203/items/4923f912fc85940fdccb)←　→[（その５）【tweenerで移動処理】](https://qiita.com/alkn203/items/5e8ba2d77d846ccac041)

## 今回の目標
前回は、15パズルのピースをタッチできるようにしました。今回は、ピースをタッチで移動できるようにします。
...
<a href="http://runstant.com/alkn203/projects/c7da26e6" target="_blank">[runstantで確認]</a>
...
次回は、phina.jsの目玉機能の一つである**tweener**でピースの動きを滑らかにしてみます。
