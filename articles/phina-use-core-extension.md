...
## はじめに
[phina.js]()は、[phi]()氏が開発した国産の **javascript** 製ゲームライブラリです。
その名の通り、ゲーム製作を前提とした機能が充実していますが、加えて**javascript** でのコーディングをより快適にするための細かな気配りがされているライブラリでもあります。その例として、今回は、**javascript** の基本クラスである **Array** の拡張メソッド群を紹介したいと思います。
